...
public class show3 extends JFrame {
    String head[] = {"id", "Student_id", "Student_name", "book_id","book_name","issue date","due date","return date"};
    ...
    show3() {
        ...
        DefaultTableModel m1 = new DefaultTableModel(0, 8);
        ...
        try {
            conn co = new conn();
            ResultSet rs = co.s.executeQuery("select * from issue");
            while (rs.next()) {
